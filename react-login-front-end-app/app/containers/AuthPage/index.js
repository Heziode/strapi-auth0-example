...
export class AuthPage extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    ...
    const providers = ['discord', 'facebook', 'github', 'google', 'microsoft', 'twitch', 'twitter', 'instagram', 'vk', 'auth0']; // To remove a provider from the list just delete it from this array...
